...
date >> $debug_temp
cat /www/cyber-pizza/all/assets/settings/net-id.txt >> $debug_log
echo "---------------------------" >> $debug_temp
...
cat /www/cyber-pizza/all/assets/settings/my-adb.txt >> $debug_log
cat /www/cyber-pizza/all/assets/settings/my-conn.txt >> $debug_log
cat /www/cyber-pizza/all/assets/settings/my-vpn.txt >> $debug_log
echo -e "*-*-*-*-*-*-*\n" >>$debug_temp
echo "speed test server" >> $debug_temp
cat /www/cyber-pizza/all/assets/settings/speed-server.txt >> $debug_log
